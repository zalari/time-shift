...
export const queryFields = {
  timeSince: {
    label: 'Starting Time',
    description: 'Starting time of the entry',
    type: 'date',
  },
  timeUntil: {
    label: 'End Time',
  ...
  filter: {
    ...
    fields: {
      ...
      timeInsert: {
        label: 'Insert Time',
        description:
          'Insert time of the entry in ISO 8601 UTC format (e.g. "2021-06-30T12:34:56Z")',
        type: 'string',
      },
      timeLastChange: {
      ...
      servicesName: {
        label: 'Services name',
        description:
          'Name of the corr. service. Only in list function with enhanced list mode enabled',
        type: 'string',
        multiple: true,
        // values will be added later, once the connection is configured
        options: [{ label: '', value: '' }],
